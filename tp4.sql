...
-- Tiempo de generación: 18-01-2023 a las 03:14:44
...
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  `precio` text COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `productos` (`id`, `titulo`, `imagen`, `precio`) VALUES
(1, 'algo', 'asd', 'asd'),
(2, 'otro', 'asd', 'ada'),
(4, 'ahshsahashsasgs', 'hashashasahs', 'hashasahs');
